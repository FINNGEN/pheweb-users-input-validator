...
from utils.check_stats_req25GBmem import check_stats, timing
...
def main():
    ...
    report = "\n".join([mes_start, report_meta, report_stats, sep,
        tot_stats, table_border, tot_success_mes, sep, mes_input, mes_output, '\n', infomes, 
    ...
    # print on the screen
    print('\n'.join([sep, tot_stats, table_border, tot_success_mes, sep, mes_input, 
                    mes_output, mes_end, exec_time]))
